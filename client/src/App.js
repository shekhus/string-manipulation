...
const [length ,setLength] = useState(unefined);
const [concatenation,setConcatenation] =useState(unefined);
...
//to save web3 in a contract in state of the conponent
setWeb3(web3);
setContract(contract);
 ...
 async function calculateLength(e){
  ...
  //access the function in smart contract i.e length 
  //then extract the word we pass into the form (value of firts input)
 ...
 async function concatenate(e){
  ...
  //access the function in smart contract i.e length 
  //then extract the word we pass into the form (value of firts input)
  .concatenate(e.target.elements[0].value,
